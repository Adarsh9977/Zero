    ...
    return (
      <input
        className={cn(
          ...
          'placeholder:animate-shine placeholder:bg-linear-to-r placeholder:from-neutral-500 placeholder:via-neutral-300 placeholder:to-neutral-500 placeholder:bg-[length:200%_100%] placeholder:bg-clip-text placeholder:text-transparent',
